...
{
    /// <summary>
    /// These are all the methods that work with the CardSet Table in the database. 
    ...
    public class DALCardSet
    {
        ...
        internal int InsertCardSet(CardSet cardSet)
        {
        ...
        internal CardSet GetCardSetById(int cardSetId)
        {
            string connStr = configuration.GetConnectionString("DefaultConnection");
            SqlConnection conn = new SqlConnection(connStr);
            conn.Open();
        ...
        internal CardSet UpdateCardSet(CardSet cardSet)
        {
            string connStr = configuration.GetConnectionString("DefaultConnection");
            SqlConnection conn = new SqlConnection(connStr);
            conn.Open();
        ...
        internal void DeleteCardSet(int cardSetId)
        {
            string connStr = configuration.GetConnectionString("DefaultConnection");
            SqlConnection conn = new SqlConnection(connStr);
            conn.Open();
